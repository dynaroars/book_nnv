...
\item Important: this class does not require or teach about AI or deep learning concepts. It also does not assume prior knowledge of these topics, and all background material will be provided.
\end{itemize}
...
topic will follow roughly the same sequence of preparation and reading materials before class, in-class
learning activities and homework/project assignments. Many of these activities will be group based.
