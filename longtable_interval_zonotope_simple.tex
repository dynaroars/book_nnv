...
Consider the DNN in~\autoref{fig:dnn-abs} with inputs $x_1 \in [-2, 2]$ and $x_2 \in [-1, 3]$.
...
\multirow{22}{*}{Affine} & \myintervalprerelu{1}{1}     & \myzonotopeprerelu{1}{1} \\ \cmidrule(lr){2-3}
...
\multirow{11}{*}{Affine} & \myintervalprerelu{2}{1}     & \myzonotopeprerelu{2}{1} \\ 
\bottomrule
\end{longtable}
