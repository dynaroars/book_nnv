...
To extract the preconditions and postconditions from a VNNLIB property, you can use provided code here\footnote{\url{https://github.com/dynaroars/book_nnv/blob/4bacdfdb58e01441afb8de84f8955c86390479e6/code/pa4/objective.py\#L181}}:
...
Download ACAS XU benchmarks from here\footnote{\url{https://github.com/dynaroars/neuralbench/tree/main/instances/acasxu}}.
...
Your task is to:
\begin{enumerate}
    \item enumerate all instances in \texttt{instances.csv} and verify the properties.
    \item report the result for each instance, either, UNSAT, SAT, or TIMEOUT.
    \item check the results with the ground truth.
\end{enumerate}
