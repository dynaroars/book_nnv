...
\end{itemize}
You can use \texttt{acasxu\_instances\_w\_ground\_truth.csv} instead of the \texttt{instances.csv} in the repo.
It contains the same instances as \texttt{instances.csv}, but also includes the ground truth results for each instance.
Its avaliable from \url{https://github.com/dynaroars/book_nnv/blob/main/code/pa4/acasxu_instances_w_ground_truth.csv}
...
\begin{enumerate}
    ...
    \item check the results with the ground truth at \url{https://github.com/dynaroars/book_nnv/blob/main/code/pa4/acasxu_instances_w_ground_truth.csv}.
\end{enumerate}
