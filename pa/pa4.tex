...
Download ACAS XU benchmarks from \url{https://github.com/dynaroars/neuralbench/tree/main/instances/acasxu}.
...
Your task is to:
\begin{enumerate}
    \item enumerate first 45 instances in \texttt{instances.csv} and verify the properties, the rest are optional.
