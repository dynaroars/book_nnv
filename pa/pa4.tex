...
\begin{enumerate}
    \item A single python file \code{verify.py} that accepts three command line arguments, and run the verification. This provides a unified interface for us to test your implementation.
        ...
        E.g.
        python verify.py acasxu/Network1_1.onnx acasxu/Property7.vnnlib 120
        Would run the verifier on the given network and property with a timeout of 120 seconds.
        \end{listlisting}
...
\begin{enumerate}
    ...
    \item some timeouts are expected, we do not expect you to verify all instances.
