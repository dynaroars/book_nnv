...
Make sure there is at least on dimension perturbed, e.g., input\_lower should not be equal to input\_upper, or otherwise, the input space is just a single point and no need to use abstraction.
