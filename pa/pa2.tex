...
\begin{itemize}
\item 20 points — for complete interval and zonotope abstraction implementation
    \begin{itemize}
    \item 4 points for \texttt{LinearTransformer} for Interval Abstraction
    \item 4 points for \texttt{ReluTransformer} for Interval Abstraction
    \item 2 points for zonotope representation functions (\texttt{zonotope} and \texttt{concrete})
    \item 5 points for \texttt{LinearTransformer} for Zonotope Abstraction
    \item 5 points for \texttt{ReluTransformer} for Zonotope Abstraction
    \end{itemize}
