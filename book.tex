...
% ### How SAT/SMT Solving Thinks

% SAT/SMT-based techniques encode the program and the **negation of the property** as constraints.

% For `clip`, the tool encodes:

% * The program logic
% * The assertion: “output < 0 or output > 10”

% Then it asks:

% > Is this formula satisfiable?

% If the answer is **unsatisfiable**, the property is proved.
% If **satisfiable**, the solver produces a concrete counterexample.

% ### Strengths and Limitations

% * Fully automated
% * Produces counterexamples
% * Can handle real arithmetic
% * May struggle with scalability

% SAT/SMT solving is central to modern neural network verification tools.
