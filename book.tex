...
\part{Proof Generation and Checking}\label{part:proof}

Advances in DNN verification have made it possible to reason about the safety and robustness of complex 
