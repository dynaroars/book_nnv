...
\item In the case of numerous hidden neurons, the priorization of hidden neurons is already done by branching heuristics, e.g., ranking neuron importance based on some metrics.
