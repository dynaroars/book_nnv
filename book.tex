...
\begin{equation}
    \forall x_1, x_2, \|x_1 - x_2\| \leq \epsilon \implies f(x_1) = f(x_2).
\end{equation}
...
\]
where $\|x - c\| \leq \epsilon$ indicates that the difference between the two images is within a certain (small) threshold, which is typically defined in terms of pixel-wise differences. \tvn{is this local or global robustness?}\hd{it is the definition of local robustness.}
\end{example}
