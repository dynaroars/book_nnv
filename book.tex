...
The piecewise linearity makes ReLU easy to reason about, but it also introduces non-linearity that complicates verification (and makes DNN verification $\mathsf{NP}$-complete as shown in~\autoref{sec:complexity}). We will use ReLU throughout this book as the default activation function for hidden neurons in a DNN. 
