...
\[
\begin{aligned}
& 5x + 20y \le 200 (x + 4y \le 40)\\
& 3x + y \le 80 \\
& 20x + 70y \le 800 (2x + 7y \le 80)\\
& x \ge 0 \\
& y \ge 0.
\end{aligned}
\]
...
& (0, 10) \\
& (\frac{80}{3} ,0) \\
& x + 4 y = 40 ~\&~ 3x + y = 80 \implies (x,y) = (\frac{280}{11},\frac{40}{11}) \text{ (also feasible with $2x + 7y \le 800$)}
\end{aligned}
\]



Now, we can evaluate the objective function $P = 30x + 50y$ at each vertex:
