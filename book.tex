...
A neural network (NN) can be viewed as a graph where each node carries out a specific operation. Collectively, this graph defines a function $f$ mapping vectors of real numbers to other vectors of real numbers: 
