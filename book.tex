...
\begin{itemize}
    \item Write down the problem and cite the sources (e.g., exact URL or author(s)/Title/Year if from a paper).
    \item Formulate the problem as a MILP (clearly indicate the objective, constraints).
