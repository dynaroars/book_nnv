...
\autoref{tab:nn-types} summarizes the most popular types of neural networks and their typical applications. \tvn{need some simple pictures (like \autoref{fig:dnn}) to illustrate each type used in DNN verif..}
