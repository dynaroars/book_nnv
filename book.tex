...
\begin{problem}\label{problem:reluplex-hand}
    \begin{itemize}
    \item Rewrite the steps in~\autoref{ex:reluplex} on paper, showing all the calculations for each step. The goal of hand-writing the steps is to help you understand how \reluplex{} works.  Take picture and submit as attachment.
