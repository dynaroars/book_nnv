...
\autoref{tab:activation} summarizes the most common activation functions used in DNNs, their equations, output ranges, and key uses.\tvn{need some simple piectures to demonstrate }
