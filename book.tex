...
It does so by conjoining $\{v_4\}$ and $\{\overline{v_4}\}$ to $\sigma_i$and adds both new activation patterns to \functiontextformat{ActPatterns}. Next, \bab{} loops back to process the next activation pattern.
