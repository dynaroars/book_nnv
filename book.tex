...
The SAT problem---checking if a propositional formula is satisfiable---is \NP-Complete~\cite{cook2023complexity,karp2009reducibility}.
...
\section{The DPLL SAT Solving Algorithm}\label{sec:dpll}
