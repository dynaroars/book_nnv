...
\subsection{Conjunctive Normal Form (CNF)} A formula is in CNF if it is a conjunction of disjunctions of literals,
...
\emph{A SAT solver} takes a propositional formula, typically in CNF, as input and determines its satisfiability by searching for a satisfying assignment. If one exists, it returns the assignment; otherwise, it reports \unsat{}. 
