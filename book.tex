...
\paragraph{Fully Connected Neural Networks} A \emph{fully connected} NN connects each neuron in a layer to every neuron in the next layer.

\begin{example}
\autoref{fig:dnn} earlier showed a fully connected FNN with a single hidden layer. \autoref{fig:ffn} below shows an FNN with two hidden layers.
