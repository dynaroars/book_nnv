...
Most DNN verification tools implement \emph{adversarial attack} techniques to find counterexamples before running BaB. These techniques are often efficient and can quickly find counterexamples for invalid properties.
