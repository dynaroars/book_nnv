...
Thus, in this example, we conclude that property in~\autoref{eq:prop1} is \emph{not valid} for the DNN in~\autoref{fig:dnn-replux} because for the inputs $x_1=0,x_2=-1$, the network gives the output $x_5=0.5$, which violates the property.
\end{example}
