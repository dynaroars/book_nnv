...
\begin{example}
The parallelogram zonotope on the right captures   points with correlated \(x_1\) and \(x_2\) values, e.g., increasing \(x_1\) by moving along \(g_1\) also increases \(x_2\) due to the non-zero second component of \(g_1\). 
