...
\begin{problem}
    Suppose $y$ can take values from 0 to 3. Student A computes an interval abstraction $y \in [-2,4]$, while student B computes the interval abstraction  $y \in [1,2]$. 
    \begin{enumerate}
        \item Which student's abstraction is correct?  Explain your answer. If both are correct, which is more precise?
