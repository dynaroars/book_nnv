...
\begin{itemize}
    ...
    \item \textbf{Limited exploitation of network structure and modern hardware} General MILP solvers are designed for arbitrary linear programming problems and do not exploit DNN-specific structures such as\tvn{Hai, like what? mention those that DNN verification tools exploit}. 
    
    Moreover, MILP solvers, even industrial-strength ones like Gurobi~\cite{gurobi}, are primarily CPU-based and does not leverage the massive parallelism provided by modern GPUs.
