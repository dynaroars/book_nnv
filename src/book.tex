...
\begin{enumerate}
    ...
    \begin{itemize}
        \item Programming Assertionnment 1 (PA1): Symbolic Execution of Neural Networks~\autoref{sec:pa1}
    \end{itemize}
    \item Week 6:
    \item Week 7:
    \item Week 8:
...
Internally, \tool{} checks the satisfiability of the formula given in~\autoref{eq:prob}
\begin{equation*}
