...
\begin{exercise}[Robustness + Safety: Drone Controller]\label{exercise:drone}
...
\begin{enumerate}
    ...
    \item Week 6:
    \begin{itemize}
        \item HW due:~\autoref{exercise:z3-dnn},~\autoref{exercise:pattern-enumeration}, and ~\autoref{exercise:nnv-pattern}
    \end{itemize}
    \item Week 7:
    \item Week 8:
    \item Week 9:
