...
\begin{exercise}[Counterexample: Monotonicity in Admission]
...
\begin{enumerate}
    ...
    \item The corner or candidate points
    \item The optimal value at each corner point.
