...
To solve the NNV problem (\autoref{sec:nnv-problem}) modern DNN verifiers typically adopt the Branch-and-Bound (BaB) approach to search for satisfying activation patterns (\autoref{sec:activation-pattern}).
