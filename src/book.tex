...
Zonotopes extend intervals (\autoref{sec:interval-abstraction}) by introducing \emph{generators} that represent linear dependencies between variables and therefore lead to more precise approximations.
